            ...
            for x in range(7):
                for y in range(6):
                    if str(asiento_cliente) == asientos_gral[x][y]:
                        asientos_disp[x,y] = asientos_gral[x,y] # ESTO HACE QUE EL ASIENTO SE OCUPE
                        asientos_gral[x][y] = "X" # Esto hace que el asiento SE MUESTRE OCUPADO
                        ...
                        print("Ha reservado su pasaje exitosamente.")
